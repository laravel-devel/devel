...
namespace Devel\Modules\Activators;
...
class FileActivator implements ActivatorInterface
{
    ...
    private function writeJson(): void
    {
        $this->files->put(
            $this->statusesFile,
            json_encode($this->modulesStatuses, JSON_PRETTY_PRINT)
        );
    }
    ...
    {
        if (!$this->config->get('devel-modules.cache.enabled')) {
    ...
    {
        return $this->config->get('devel-modules.activators.file.' . $key, $default);
    }
