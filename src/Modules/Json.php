...
use Devel\Modules\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('devel-modules.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('devel-modules.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
