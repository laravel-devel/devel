...
abstract class Module
{
    ...
    {
        if (config('devel-modules.register.translations', true) === true) {
    ...
    {
        $this->app['events']->dispatch(sprintf('devel-modules.%s.' . $event, $this->getLowerName()), [$this]);
    }
    /**
    ...
    {
        return config('devel-modules.register.files', 'register') === 'boot' &&
    ...
    {
        if (config('devel-modules.cache.enabled')) {
