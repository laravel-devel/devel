...
use Extensions\Modules\Exceptions\InvalidAssetPath;
use Extensions\Modules\Exceptions\ModuleNotFoundException;
use Extensions\Modules\Process\Installer;
use Extensions\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Extensions\Modules\Module
     */
     ...
     * @return string
     * @throws \Extensions\Modules\Exceptions\ModuleNotFoundException
     */
